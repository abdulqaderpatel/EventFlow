...
class UserEnrolledEventsScreen extends StatefulWidget {
  ...
  @override
  State<UserEnrolledEventsScreen> createState() => _UserEnrolledEventsScreenState();
}
                    ...
                    child: ListView(
                      children: [
                        StreamBuilder<QuerySnapshot>(
                            stream: FirebaseTable().eventsTable.where("emails",arrayContains:FirebaseAuth.instance.currentUser!.email).snapshots(),
