                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          client["follower"].contains(FirebaseAuth.instance.currentUser!.uid)&&client["following"].contains(FirebaseAuth.instance.currentUser!.uid)?
                                              InkWell(onTap: (){
                                                List<String>
                                                ids = [
                                                  FirebaseAuth
                                                ...
                                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                                  return ChatScreen(ids.join("_"),widget.userData);
                                                }));
                                              },child: Icon(Icons.chat,color: Colors.white,)):Container()
                                        ],
                                      ),
                                    ),
                                    const SizedBox(
                              ...
                              Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    SizedBox(height:15),
                                    Icon(Icons.event,color: Colors.grey,size: 28,),
                        SizedBox(height: 15,),
                        SingleChildScrollView(
                          child: SizedBox(height: Get.height*0.54,child:   ListView(
                            children: [
                                  StreamBuilder<QuerySnapshot>(
                                  stream: FirebaseTable().eventsTable.where("emails",arrayContains:widget.userData["email"]).snapshots(),
                                  builder: (context, snapshot) {
