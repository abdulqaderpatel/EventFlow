                ...
                for (var client in clients!) {
                  final clientWidget = Container(
                    child: SingleChildScrollView(
                      child: Container( color: const Color(0xff1C2124),
                        height: Get.height,
                        child: ListView(
                          children: [
                            Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                                ...
                                                ? client["emails"].contains(
                                                    ...
                                                    ? Text("Your rating: $rate",
                                                        style: const TextStyle(
                                                            ...
                                                            fontWeight:
                                                                FontWeight.w500))
                                                    : const Text("This event is over",  style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 20,
                                        fontWeight: FontWeight.w500))
                                                : Container()),
                                    ...
                                    DateTime.now().isBefore(
                                        ...
                                        : !client["raters"].contains(FirebaseAuth
                                                .instance.currentUser!.email)
                                            ?client["emails"].contains(FirebaseAuth.instance.currentUser!.email)? RatingBar(
                                                initialRating: 0,
                                                minRating: 0,
                                                maxRating: 5,
                                    ...
                                    DateTime.now().isAfter(
                                            DateTime.parse(client["end_time"]))
                                        ?client["emails"].contains(FirebaseAuth.instance.currentUser!.email)? (client["raters"].contains(FirebaseAuth
                                                .instance.currentUser!.email)
                                            ? ElevatedButton(
                                            ...
                                            : ElevatedButton(
                                                ...
                                                child: const Text("Rate"))):Container()
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              return SingleChildScrollView(
                                                                                child:
                                                                                  ...
                                                                                  child: StatefulBuilder(builder: (BuildContext context, modalState) {
                                                                                    return Container(
                                                                                          ...
                                                                                          child: Column(
                                                                                            ...
                                                                                            children: [
                                                                                              ...
                                                                                              ElevatedButton(
                                                                                                  ...
                                                                                                  child: isLoading ? const CircularProgressIndicator() : const Text("Pay")),
                                                                                            ],
                                                                                          )),
                                                                                    );
                                                                                  }),
